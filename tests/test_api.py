...
class TestAPI:
    ...
    def test_create_stream_get_deprecated(self, client, mock_stream_manager):
        response = client.get(
            "/create_stream?url=http://example.com/stream.m3u8")
        assert response.status_code == 200
    ...
    def test_playlist_endpoint(self, client, mock_stream_manager):
        mock_stream_manager.proxy_playlist = AsyncMock(
            return_value="#EXTM3U\nsegment1.ts")
    ...
    def test_proxy_endpoint_segment(self, client, mock_stream_manager):
        ...
        mock_stream_manager.proxy_segment = AsyncMock(
            return_value=mock_proxy_generator())
    ...
    def test_direct_stream_endpoint(self, client, mock_stream_manager):
        ...
        mock_stream_manager.proxy_direct_stream = AsyncMock(
